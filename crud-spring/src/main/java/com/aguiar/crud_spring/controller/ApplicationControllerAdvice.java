...
public class ApplicationControllerAdvice {
  ...
  public String handlenNotFindExcepition(RecordNotFoundException ex) {
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public String handlerMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException ex) {
